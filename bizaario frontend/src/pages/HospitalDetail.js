...
import HospitalProfile from '../components/common/hospital/hospital-profile/HospitalProfile';
import MedicalTabs from '../components/common/hospital/hospital-profile/MedicalTabs';
import api from '../api';
  ...
  return (
    <Layout>
      <div className="container px-4 py-8 mx-auto">
        ...
        <div className="mt-8">
          <MedicalTabs hospitalData={hospitalData} />
        </div>
      </div>
    </Layout>
  );
