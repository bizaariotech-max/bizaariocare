...
import DoctorProfile from "../components/common/doctor/doctor-profile/DoctorProfile";
import MedicalTabs from "../components/common/doctor/doctor-profile/MedicalTabs";
import api from "../api";
  ...
  return (
    <Layout>
      <div className="container px-4 py-8 mx-auto">
        ...
        <div className="mt-8">
          <MedicalTabs doctorData={doctorData} />
        </div>
      </div>
    </Layout>
  );
