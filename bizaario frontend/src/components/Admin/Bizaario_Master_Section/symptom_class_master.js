    ...
    <div>
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Symptom  Class Master</h3>
                  <p>Add or update the required details for the symptom class master to keep records accurate and complete.</p>
                  </div>
