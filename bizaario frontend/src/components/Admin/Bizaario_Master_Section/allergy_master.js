...
function AllergyMaster() {

  const[loading,setloading]=useState(false)
     const [allergy_master, setallergy_master] = useState({
    ...
    alert("delete")
     ...
     const column = [
        ...
        { field: 'other', headerName: 'Purpose',flex:1,  renderCell: (params) => {
            return params.row?.other?.allergic_symptoms || "";
        }},
 ...
 <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Allergy Master</h3>
                  <p>Add or update the required details for the allergy master to keep records accurate and complete.</p>
                  </div>
      ...
      <div className="form-grid">
            ...
            <Select 
             ...
             MenuProps={{
                ...
                renderValue={(selected) => {
                  if (!selected) {
                    return <span style={{ color: "#9ca3af" }}>Allergy Category</span>; // grey placeholder
                  }
       ...
       <FormControl fullWidth size="small">
            ...
            <TextField 
              name="allergy_name"
              defaultValue={allergy_master.allergy_name}
              onChange={handlechange}
