...
function RiskFactorMaster() {

  const[loading,setloading]=useState(false)
     const [risk_factor_master, setrisk_factor_master] = useState({
        risk_factor: "",
  ...
  const onDeletehospital=()=>
  {
    alert("delete")
     ...
     const columns = [
        ...
        { field: 'lookup_value', headerName: 'Risk Factor', flex: 0.5 },
      ...
      const rows = all_risk_factor_master?.map((doc, index) => ({
        id: doc._id || index,
        ...doc,
      }));
  ...
  setrisk_factor_master((prev) => {
    ...
    return { ...prev, [name]: type === "checkbox" ? checked : value };
        ...
        const add_risk_factor_master = async () => {
        try {
          setloading(true)
          ...
          if (resp.data.response.response_code === "200") {
              Swal.fire({
                      icon:"success",
                      title:"Risk Factor Master Added",
                      text:"Risk Factor Master Addedd Successfully...",
  ...
  <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Risk Factor Master</h3>
                  <p>Add or update the required details for the risk factor master to keep records accurate and complete.</p>
                  </div>
      ...
      <div className="form-grid">
       ...
       <FormControl fullWidth size="small">
            ...
            <TextField 
              name="risk_factor"
              defaultValue={risk_factor_master.risk_factor}
          ...
          <Button
           className='submit-button'
            onClick={add_risk_factor_master}
          >
            Submit
          </Button>
        </Paper>
