...
function SecondOpinionQueryMaster() {

  const[loading,setloading]=useState(false)
     const [second_opinion_query_master, setsecond_opinion_query_master] = useState({
    ...
    const onEdit=(row)=>
    {
       ...
       setsecond_opinion_query_master({
  ...
  const onDeletehospital=()=>
  {
    alert("delete")
     ...
     const columns = [
        ...
        { field: 'lookup_value', headerName: 'Second Opinion Query Type', flex: 0.5 },
      ...
      const rows = all_second_opinion_query_master?.map((doc, index) => ({
        id: doc._id || index,
        ...doc,
      }));
  ...
  setsecond_opinion_query_master((prev) => {
    ...
    return { ...prev, [name]: type === "checkbox" ? checked : value };
        ...
        const add_second_opinion_query_master = async () => {
        try {
          setloading(true)
          ...
          if (resp.data.response.response_code === "200") {
              Swal.fire({
                      icon:"success",
                      title:"Second Opinion Query Type Added",
                      text:"Second Opinion Query Type Addedd Successfully...",
   ...
   <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Second Opinion Query Master</h3>
                  <p>Add or update the required details for the second opinion query master to keep records accurate and complete.</p>
                  </div>
      ...
      <div className="form-grid">
       ...
       <FormControl fullWidth size="small">
            ...
            <TextField 
              ...
              defaultValue={second_opinion_query_master.second_opinion_query_type}
          ...
          <Button
            ...
            onClick={add_second_opinion_query_master}
          >
            Submit
          </Button>
        </Paper>
