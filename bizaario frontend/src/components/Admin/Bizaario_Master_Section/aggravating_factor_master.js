...
function AggravatingFactorMaster() {

  const[loading,setloading]=useState(false

  )
     const [aggravating_factor_master, setaggravating_factor_master] = useState({
    symptom_id: null,
    aggravating_factor: "",
...
//========================================= get symtom class id ================================================
  ...
  setaggravating_factor_master((prev) => {
           ...
           const resp = await api.post("api/v1/admin/SaveLookup",
            {
              ...
              lookup_value:aggravating_factor_master.aggravating_factor,
              parent_lookup_id:aggravating_factor_master.symptom_id,
 ...
 <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Aggravating Factor Master</h3>
                  <p>Add or update the required details for the aggravating factor master to keep records accurate and complete.</p>
                  </div>
      ...
      <div className="form-grid">
       ...
       <FormControl fullWidth size="small">
            ...
            <Select 
              name="symptom_id"
              value={aggravating_factor_master.symptom_id}
             ...
             MenuProps={{
                ...
                renderValue={(selected) => {
                  if (!selected) {
                    return <span style={{ color: "#9ca3af" }}>Select Symptom</span>; // grey placeholder
                  }
                  return symtop_id.find((item) => item._id === selected)?.lookup_value;
                }}
            >
           ...
           <FormControl fullWidth size="small">
            ...
            <TextField 
              ...
              value={aggravating_factor_master.aggravating_factor}
              onChange={handlechange}
