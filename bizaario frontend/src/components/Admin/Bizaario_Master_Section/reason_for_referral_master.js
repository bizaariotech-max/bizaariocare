...
function ReasonForReferral() {
  ...
  const[loading,setloading]=useState(false)
     ...
     const [reason_for_referral, setreason_for_referral] = useState({
            reason_for_referral: "",
  ...
  const onEdit=(row)=>
  {
    ...
    setreason_for_referral({reason_for_referral:row.lookup_value})
  }
  ...
  const onDeletehospital=()=>
  {
    alert("delete")
     ...
     const column = [
        ...
        { field: 'lookup_value', headerName: 'Reason For Referral', flex: 0.5 }, 
       {
      field: 'actions',
      headerName: 'Actions',
      width: 80,
      ...
      const rows = all_reason_for_referral?.map((doc, index) => ({
        id: doc._id || index,
        ...doc,
      }));
  ...
  setreason_for_referral((prev) => {
    ...
    return { ...prev, [name]: type === "checkbox" ? checked : value };
        ...
        const add_reason_for_referral = async () => {
        try {
          setloading(true)
          ...
          if (resp.data.response.response_code === "200") {
              Swal.fire({
                      icon:"success",
                      title:"Reason For Referral Added",
                      text:"Reason For Referral Addedd Successfully...",
   ...
   <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Reason For Referral Master</h3>
                  <p>Add or update the required details for the reason for referral master to keep records accurate and complete.</p>
                  </div>
      ...
      <div className="form-grid">
           ...
           <FormControl fullWidth size="small">
            ...
            <TextField 
              ...
              defaultValue={reason_for_referral.reason_for_referral}
          ...
          className='submit-button'
            onClick={add_reason_for_referral}
          >
            Submit
          </Button>
        </Paper>
