...
function TherapyMaster() {
  ...
  const onDeletehospital=()=>
  {
    alert("delete")
     ...
     const columns = [
      ...
      const rows = all_therapy_master?.map((doc, index) => ({
        id: doc._id || index,
        ...doc,
      }));
  ...
  settherapy_master((prev) => {
    ...
    return { ...prev, [name]: type === "checkbox" ? checked : value };
        ...
        const add_therapy_master = async () => {
        try {
          setloading(true)
          ...
          if (resp.data.response.response_code === "200") {
              Swal.fire({
                      icon:"success",
                      title:"Therapy Master Added",
                      text:"Therapy Master Addedd Successfully...",
  ...
  <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Therapy Master</h3>
                  <p>Add or update the required details for the therapy master to keep records accurate and complete.</p>
                  </div>
      ...
      <div className="form-grid">
           ...
           <FormControl fullWidth size="small">
            ...
            <TextField 
              name="therapy_name"
              defaultValue={therapy_master.therapy_name}
