...
import '../Admin/admincss/service-category.css'
...
<div className='service-category'>
        <div className='profile-header'>
                  <h3>Enter Details for Service Category Master</h3>
                  <p>Add or update the required details for the service category master to keep records accurate and complete.</p>
                  </div>
