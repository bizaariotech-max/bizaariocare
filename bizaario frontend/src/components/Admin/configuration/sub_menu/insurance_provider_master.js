...
function InsuranceProviderMaster() {
      ...
      const getall_station=async()=>
      {
        try {
          ...
          setall_station(resp.data.data.list)
    ...
    <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Insurance Provider</h3>
                  <p>Add or update the required details for the insurance provider to keep records accurate and complete.</p>
                  </div>
     ...
     <FormControl fullWidth size="small">
         ...
         <FormControl fullWidth size="small">
          ...
          />
           ...
           <FormControl fullWidth size="small">
          <label className="form-label">Is Goverment Scheme</label>
