...
function HealthProfillingQuestions() {
  ...
  const[health_profiling_question,sethealth_profiling_question]=useState({
    Health_Profilling_Question_Category:"",
    Health_Profilling_Group_Id:"",
    Question_Order:"",
    Logical_group:"",
    Investigation_Type_Id:"",
    Question_Type:"",
    Health_Profilling_Question:"",
    Option_Values:[],
    Selection_Type:"",
    Input_Type:"",
    Validity_Min:"",
...
console.log(investigation_master);
   ...
   <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Health Profilling Questions</h3>
                  <p>Add or update the required details for the health profilling questions to keep records accurate and complete.</p>
                  </div>
      ...
      <div className="form-grid">
             ...
             <label className="form-label">Health Profiling Question Category</label>
            <Select 
            ...
            >
                ...
                </MenuItem>
             {
                ...
                <FormControl fullWidth size="small">
             <label className="form-label">Health Profiling Group ID</label>
            <Select 
              name="Investigation_CategoryId"
              value={investigation_master.Investigation_CategoryId}
              onChange={handlechange}
