...
const PreviewFormData = ({incorporationdetails}) => {
  return (
    <>
      <div className="bg-white rounded-xl shadow p-4">
            <h3 className="font-semibold mb-4">Preview</h3>
            <div className="flex items-center justify-between mb-3">
              <p className="font-semibold">Incorporation Details</p>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600  flex-wrap gap-x-6 text-[12px]">
                  <p>Registration Body : <span  className="text-[#000000] font-semibold">{incorporationdetails?.RegistrationBody || ""}</span></p><br></br>
                  <p>Registration Certificate : <span  className="text-[#000000] font-semibold">{incorporationdetails?.RegistrationCertificate || ""}</span></p><br></br>
                  <p>Registration Year : <span  className="text-[#000000] font-semibold">{incorporationdetails?.RegistrationYear || ""}</span></p><br></br>
                  <p>Registration Number : <span  className="text-[#000000] font-semibold">{incorporationdetails?.RegistrationNumber || ""}</span></p><br></br>
                  <p>Validity Expiry : <span  className="text-[#000000] font-semibold">{incorporationdetails?.ValidityExpiry || ""}</span></p>
                </div>
              </div>
            </div>
