  ...
  return (
    <div>
      ...
      <div className="layout">
        ...
        <h2 className="mb-2 text-2xl font-semibold" style={{fontFamily:"Lora"}}>
       ...
       <div className="flex items-center justify-between w-full gap-2 flex-nowrap">
        <h2 
          className="font-semibold text-xl font-[Lora] truncate">
          Doctor's Profiling
        </h2>
      ...
      >
        ...
        <span>Preview</span>
            ...
            <div className="flex gap-2 mt-10 overflow-x-auto flex-nowrap sm:overflow-visible" style={{cursor:"pointer"}}>
          ...
          style={{
            ...
            gap: "9px",
            borderRadius: "10px",
            background:isactive==="Clinic Details" ? "#52677D" : "rgba(82, 103, 125, 0.15)",
          }}
        >
          <span
            style={{
              ...
              fontWeight: "bold",
              fontSize: "16px",
              color: isactive==="Clinic Details" ? "white" : "black",
              fontFamily:"Lora"
            }}
          >
            1
          </span>
          <p style={{ margin: 0, color: isactive==="Clinic Details" ? "white" : "black", fontWeight: "600",fontFamily:"Lora",whiteSpace: "nowrap" }}>Clinic Details</p>
        </div>
...
{/* =================================profiling ==============================================*/}
          ...
          style={{
            ...
            gap: "9px",
            borderRadius: "10px",
            background:isactive==="Profiling" ? "#52677D" : "rgba(82, 103, 125, 0.15)",
          }}
        >
          <span
            style={{
          ...
          <p style={{ margin: 0, color: isactive==="Profiling" ? "white" : "black", fontWeight: "600",fontFamily:"Lora",whiteSpace: "nowrap" }}>Profiling</p>
        </div>
...
{/* =================================specialties and charge ======================================*/}
          ...
          style={{
            ...
            gap: "9px",
            borderRadius: "10px",
            background:isactive==="Specialties & Charge" ? "#52677D" : "rgba(82, 103, 125, 0.15)",
          }}
        >
          <span
            style={{
              ...
              fontWeight: "bold",
              fontSize: "16px",
              color: isactive==="Specialties & Charge" ? "white" : "black",
              fontFamily:"Lora"
            }}
          >
            3
          </span>
          <p style={{ margin: 0, color: isactive==="Specialties & Charge" ? "white" : "black", fontWeight: "600",fontFamily:"Lora",whiteSpace: "nowrap"  }}>Specialties & Charge</p>
        </div>
  ...
  {/*======================================= bank details======================================= */}
          ...
          style={{
            ...
            gap: "9px",
            borderRadius: "10px",
            background:isactive==="Bank Details" ? "#52677D" : "rgba(82, 103, 125, 0.15)",
          }}
        >
          <span
            style={{
          ...
          <p style={{ margin: 0,  color: isactive==="Bank Details" ? "white" : "black", fontWeight: "600",fontFamily:"Lora",whiteSpace: "nowrap" }}>Bank Details</p>
        </div>
  ...
  {/*================================== clinic schedule========================================= */}
          ...
          style={{
            ...
            gap: "9px",
            borderRadius: "10px",
            background:isactive==="Clinic Schedule" ? "#52677D" : "rgba(82, 103, 125, 0.15)",
          }}
        >
          <span
            style={{
              ...
              fontWeight: "bold",
              fontSize: "16px",
              color: isactive==="Clinic Schedule" ? "white" : "black",
              fontFamily:"Lora"
            }}
          >
            5
          </span>
          <p style={{ margin: 0, color: isactive==="Clinic Schedule" ? "white" : "black", fontWeight: "600",fontFamily:"Lora",whiteSpace: "nowrap" }}>Clinic Schedule</p>
        </div>
...
{/*============================= second form section ===========================================*/}
             ...
             <div
              ...
              <div
                style={{
                  display: isactive==="Specialties & Charge" ? "flex" : "none",
                  width: "100%",
                  height: "auto",
                  flexDirection: "column",
                  gap: "9px",
