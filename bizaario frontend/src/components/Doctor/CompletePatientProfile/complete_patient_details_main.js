    ...
    <Doctorsidebar/>
      <div className=" min-h-screen mt-2 px-2 sm:ml-0 sm:mr-0  md:ml-[5vw] md:mr-[2vw] lg:ml-[18.5vw] lg:mr-[1.5vw]">
        ...
        <p className="text-gray-600 mb-6" style={{fontFamily:"Poppins"}}>
          Add or update the required details for the patient complete profilling to
...
{/*======================================== patient master================================== */}
              ...
              onClick={()=>setisactive("Patient Master")}
                style={{             
                    background:isactive==="Patient Master" ? "var(--div-background-active)" : "var(--div-background-inactive)",
                }}
            >
          <span
          className='patient-tab-details'
            style={{
              color: isactive==="Patient Master" ? "var(--white)" : "var(--black)",
            }}
          >
            1
          </span>
          <p style={{ margin: 0, color: isactive==="Patient Master" ? "var(--white)" : "var(--black)", fontWeight: "600",fontFamily:"Lora",whiteSpace: "nowrap" }}>Patient Master</p>
        </div>
...
{/* ================================= patient profiling ==============================================*/}
          ...
          style={{
            background:isactive==="Patient Profilling" ? "var(--div-background-active)" : "var(--div-background-inactive)",
          }}
        >
          <span
          className='patient-tab-details'
            style={{
              ...
              color: isactive==="Patient Profilling" ? "var(--white)" : "var(--black)",
            }}
          >
            2
          </span>
          <p style={{ margin: 0, color: isactive==="Patient Profilling" ? "var(--white)" : "var(--black)", fontWeight: "600",fontFamily:"Lora",whiteSpace: "nowrap" }}>Patient Profilling</p>
        </div>
...
{/* =================================patient referral=== ======================================*/}
          ...
          style={{
            ...
            background:isactive==="Patient Referral" ? "var(--div-background-active)" : "var(--div-background-inactive)",
          }}
        >
          <span
          className='patient-tab-details'
            style={{
              color: isactive==="Patient Referral" ? "var(--white)" : "var(--black)",
              
            }}
          >
            3
          </span>
          <p style={{ margin: 0, color: isactive==="Patient Referral" ? "var(--white)" : "var(--black)", fontWeight: "600",fontFamily:"Lora",whiteSpace: "nowrap"  }}>Patient Referral</p>
        </div>
