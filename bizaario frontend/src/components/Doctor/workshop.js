...
import {Paper,Button,Typography,TextField,FormControl,Select,MenuItem,Menu,IconButton,CircularProgress,
} from "@mui/material";
...
import "../Admin/configuration/style/common_config.css"
      ...
      <div className="layout">
        ...
        <div className="content-wrapper">
         ...
         <div className='profile-header'>
                  <h3>Enter Details for Workshop</h3>
                  <p>Add or update the required details for the workshop to keep records accurate and complete.</p>
                  </div>
              {/* Form */}
