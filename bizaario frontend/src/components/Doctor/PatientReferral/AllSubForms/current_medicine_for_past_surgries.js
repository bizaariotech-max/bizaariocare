...
const CurrentMedicineForPastSurgeries = () => {
  ...
  return (
    <div className="space mt-4">
         ...
         <div className="p-4 bg-gray-50 border-t border-gray-200">
           ...
           <p>
            Following your recent consultation,I have prescribed [specific medication(s),dosage,
            and duration,e.g,Amoxicillin 500mg, twice daily for 7 days] to address your [specifie condition,
            eg,bacterial sinus infection].
           </p>
         </div>
       </div>
  );
...
export default CurrentMedicineForPastSurgeries
