...
import {Paper,Button,Typography,Card,Avatar,TextField,FormControl,InputLabel,Select,MenuItem,RadioGroup,
...
import "../Admin/ContentMaster/content_master.css";
      ...
      <div className="layout">
        ...
        <div className="content-wrapper">
          ...
          <div className='profile-header'>
                  <h3>Enter Details for News And Articles</h3>
                  <p>Add or update the required details for the news and articles to keep records accurate and complete.</p>
                  </div>
...
export default DoctorNewsAndArticles;
