...
function Updateworkexperience() {
  ...
  const [doctorprofileworkexperience, setdoctorprofileworkexperience] =
    useState({
      doctor_id: "",
      hospital_name: "",
      from_year: "",
  ...
  const updateworkexperience = async (index) => {
    try {
      ...
      const resp = await api.put(
        `doctor/updateworkexperience/${doctordetails.user._id}/${indexforupdate}`,
        doctorprofileworkexperience
      );
      ...
      if (result.isConfirmed) {
        try {
          ...
          const resp = await api.delete(
            `doctor/deleteworkexperience/${doctordetails.user._id}/${workindex}`
          );
