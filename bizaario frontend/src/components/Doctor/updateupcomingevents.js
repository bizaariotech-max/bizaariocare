...
function Updateupcomingevent() {
  ...
  const getdoctorby_id = async () => {
    try {
      const resp = await api.get(
        `doctor/getdoctorbyid/${doctordetails.user._id}`
      );
  ...
  const [doctorprofileaddupcomingevents, setdoctorprofileaddupcomingevents] =
    useState({
      doctor_id: "",
      event_id: "",
      event_type: "",
      ...
      if (result.isConfirmed) {
        try {
          ...
          const resp = await api.delete(
            `doctor/deleteupcomingevents/${doctordetails.user._id}/${index}`
          );
  ...
  const updateevents = async (index) => {
    try {
      ...
      const resp = await api.put(
        `doctor/updateupcomingevents/${doctordetails.user._id}/${eventindex}`,
        doctorprofileaddupcomingevents,
        {
          headers: {
          ...
          <div className="p-4 mx-auto space-y-6 lg:p-8 lg:space-y-8">
            ...
            <div className="p-6 rounded-lg ">
              ...
              <div className="flex items-center justify-between mb-8 work-experience">
                ...
                <div className="flex items-center gap-3 work-experincemain">
          ...
          <div className="mt-3 row">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6 gallery-image sm:grid-cols-3 lg:grid-cols-5 lg:gap-6">
              {doctorprofileaddupcomingevents.event_image.length > 0 ? (
                doctorprofileaddupcomingevents.event_image.map(
                  (imgUrl, index) => (
                    <div
                      key={index}
            ...
            <div class="upload-drop-zone">
              ...
              <div class="upload-instructions">
                ...
                {doctorprofileaddupcomingevents.event_image.length})
