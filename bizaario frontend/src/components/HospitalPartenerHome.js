...
const HospitalPartenerHome = () => {
  ...
  return (
    <div className="">
      <section className=" mb-24 spacing-top empoering-section partner-list-home">
        <div className="container">
          <div className="row">
            ...
            <div className='flex justify-between gap-8'>
              <div className="col-lg-10 col-12 px-0 mb-4 medical-tab-buttons">
                <Carousel
                  arrows={false}
              ...
              <div className="col-lg-2 col-12 d-flex justify-content-end">
                <div className="mb-4">
                  <div className="input-group border-[var(--primary)]" >
                    ...
                    <select className="form-select border-start-0 text-[var(--primary)]">
                      <option value="" className='text-[var(--primary)]' disabled >Select Country</option>
