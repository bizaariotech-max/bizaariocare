            ...
            <div className="mb-6">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="w-8 h-8 flex items-center justify-center rounded-full bg-[var(--primary)] text-white hover:opacity-90"
                >
                  ›
                </button>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
                />
              </div>
              <div>
            ...
            <div>
              <button
                ...
                className="px-8 py-3 bg-[var(--primary)] text-white font-semibold rounded hover:opacity-90 transition-opacity"
              >
                Make Payment
              </button>
            </div>
