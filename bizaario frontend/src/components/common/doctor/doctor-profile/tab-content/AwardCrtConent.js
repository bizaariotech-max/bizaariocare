...
const AwardCrtConent = ({ doctorData }) => {
  // Use dynamic awards from doctorData or fallback to static data
  const awards = doctorData?.awardsRecognitions || awardCrtArr;
  
  console.log('AwardCrtConent - doctorData:', doctorData);
