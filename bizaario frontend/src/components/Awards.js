              ...
              <div className="container">
                  <div className="row">
                      <div className="d-flex justify-content-between align-items-center mb-2">
                          <div>
                              <h2 style={{fontFamily:"Lora",fontSize:"36px",fontWeight:700}}>Awards & Certification</h2>
                              <p style={{fontFamily:"sans-serif",fontSize:"16px",color:"#52677D"}}>Learn from leading doctors and specialists through
