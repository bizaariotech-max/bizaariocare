        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-8 col-12">
                    ...
                    Shop smarter for your health-curated medical supplies and welness products at your fingertips.</p>
                </div>
            ...
            <div className="row">
                       ...
                       <div className="doctor-slider mt-4 position-relative">
                           ...
                           <div className="" key={element.id} style={{
                               ...
                               <img src={element.image} alt="doctor" className=" mx-auto img-fluid" style={{width: '100%',height:"363px"}} />
