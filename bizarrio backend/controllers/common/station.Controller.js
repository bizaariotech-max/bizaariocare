...
exports.stationList = async (req, res) => {
  try {
    ...
    const list = await Station.find(query)
      ...
      .populate("OrgUnitLevel", "org_unit_type_master")
      .populate("CountryGroupId", "country_group_type_master")
      .populate("Currency", "currency_type_master")
      .skip((page - 1) * limit)
      .limit(limit)
      .sort({ createdAt: -1 });
...
exports.getStationById = async (req, res) => {
  try {
    ...
    const station = await Station.findById(id)
      .populate("ParentStationId", "StationName")
      .populate("OrgUnitLevel", "org_unit_type_name")
      .populate("CountryGroupId", "country_group_type_name")
