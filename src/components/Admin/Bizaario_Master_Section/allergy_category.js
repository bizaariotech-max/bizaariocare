...
function AllergyCategory() {
  ...
  const[loading,setloading]=useState(false)
     ...
     const [allergy_category_master, setallergy_category_master] = useState({
            allergy_category: "",
  ...
  const onEdit=(row)=>
  {
    ...
    setallergy_category_master({allergy_category:row.lookup_value})
  }
  ...
  const onDeletehospital=()=>
  {
    alert("delete")
     ...
     const column = [
        ...
        { field: 'lookup_value', headerName: 'Allergy Category', flex: 0.5 }, 
       {
      field: 'actions',
      headerName: 'Actions',
      width: 80,
  ...
  setallergy_category_master((prev) => {
 ...
 <Adminheader />
      ...
      <div className="layout">
        ...
        <div className='profile-header'>
                  <h3>Enter Details for Allergy Category Master</h3>
                  <p>Add or update the required details for the allergy category master to keep records accurate and complete.</p>
                  </div>
      ...
      <div className="form-grid">
           ...
           <FormControl fullWidth size="small">
            ...
            <TextField 
              ...
              defaultValue={allergy_category_master.allergy_category}
